...
public interface CourseRepository extends CrudRepository<Course, Integer> {
	...
	@Query("select new com.fromero.coursesapi.dto.CourseDTO(c,cs.rating) from Course c inner join c.students cs where cs.id.studentId = :idstudent")
	List<CourseDTO> listCoursesByStudent(Integer idstudent);
